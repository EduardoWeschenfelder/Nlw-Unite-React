  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className="flex gap-3 items-center">
        ...
        <div className="px-3 py-1.5 w-72  border border-white/10 rounded-lg text-sm flex items-center">
      ...
      <div className='border border-white/10 rounded-lg'>
        <table className='w-full'>
          <thead>
            <tr className='border-b border-white/10 hover:bg-black/5'>
                ...
                <tr key={i} className='border-b border-white/10 '>
                  ...
                  <td className='py-3 px-4 text-sm text-zinc-300'>
                    <div className='flex flex-col gap 1'>
                      <span className='font-semibold text-white'>Eduardo Barbosa</span>
                      <span>eduardo@gmail.com</span>
                    </div>
                  </td>
